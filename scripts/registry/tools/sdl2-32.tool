# === METADATA ===
KOSAIO_TOOL_ID="sdl2-32"
KOSAIO_TOOL_NAME="SDL2 (32-bit)"
KOSAIO_TOOL_DESC="Simple DirectMedia Layer 2 - cross-platform multimedia library (32-bit build for Dreamcast simulation / PC_SIMULATE_DC)"
KOSAIO_TOOL_TAGS=("sdl" "sdl2" "multimedia" "video" "audio" "library" "32bit")
KOSAIO_TOOL_TYPE=("lib")
KOSAIO_TOOL_DEPS=("build-essential" "git" "gcc-multilib" "g++-multilib")

# === SOURCE CONTROL ===
KOSAIO_TOOL_REPO="https://github.com/libsdl-org/SDL.git"
KOSAIO_TOOL_BRANCH="SDL2"
...
KOSAIO_TOOL_INSTALLATION_LIBDIR="lib/sdl2/32"
...
# === UNINSTALL & HEALTH ===
KOSAIO_TOOL_LIBS=(
    "/opt/kosaio/data/lib/sdl2/32/libSDL2-2.0.so"
    "/opt/kosaio/data/lib/sdl2/32/libSDL2main.a"
)
KOSAIO_TOOL_INCLUDE_DIRS=(
    "/opt/kosaio/data/include/SDL2"
)
...
KOSAIO_TOOL_INSTALL_WARNING=(
    "CUSTOMIZABLE BUILD"
    "${C_YELLOW}Tip:${C_RESET} Edit build options with ${C_CYAN}kosaio config sdl2-32${C_RESET}."
...
KOSAIO_TOOL_INFO_EXTRA=(
    ...
    "Install path: ${C_CYAN}/opt/kosaio/data/lib/sdl2/32/${C_RESET}"
)
